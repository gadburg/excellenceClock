...
<template>
    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-center dark:bg-indigo-300 selection:bg-indigo-500 selection:text-white">
        ...
        <div class="flex justify-center items-center mt-6 mx-auto rounded-full border border-indigo-800 p-2">
            <Link :href="route('login')" class="font-semibold bg-indigo-500 text-indigo-600 hover:text-gray-900 dark:text-indigo-800 dark:hover:text-white  mx-auto rounded-full ">
