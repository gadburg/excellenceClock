...
<template>
    <ActionSection>
        ...
        <template #description>
            Administre sus sesiones activas en otros dispositivos.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Si lo necesita, puede cerrar sesión en los dispositivos. Algunas sesiones recientes se enumeran a continuación. Si cree que su cuenta ha sido comprometida, también debe actualizar su contraseña.
            </div>
                    ...
                    <div class="ms-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span v-else>Ultimo activo {{ session.last_active }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Introduzca su contraseña para confirmar que desea cerrar sesión en el resto de dispositivos.
